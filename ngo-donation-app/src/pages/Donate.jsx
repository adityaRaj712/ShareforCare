    ...
    <div className={`flex justify-center items-center h-screen`}>
      ...
      <div className="w-1/2 flex justify-center">
        <div className="text-center">
          <p className="text-2xl mb-4 text-white dark:text-white flex flex-col items-center">Scan QR to Donate</p>
          ...
          <button type="button" class="text-white bg-pink-400 hover:bg-[#050708]/80 focus:ring-4 focus:outline-none focus:ring-[#050708]/50 font-medium rounded-lg text-sm px-5 py-2.5 text-center inline-flex items-center dark:hover:bg-[#050708]/40 dark:focus:ring-gray-600 me-2 mb-2">
